 ...
 * @author Baltazar
 */
public class Compras_Calzado extends javax.swing.JFrame {

    int cont=0;
    public Compras_Calzado() {
        initComponents();
...
//      JC_categoria.setAnchoDeBorde(TOP_ALIGNMENT);
    ...
    private void initComponents() {
        ...
        panelRectTranslucido1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, -1, -1));
        ...
        jButton4.setBackground(new java.awt.Color(179, 212, 244));
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Estilo", "Talla", "Color", "Marca"
            }
        ));
        ...
        jButton5.setBackground(new java.awt.Color(179, 212, 244));
...
//        JFrame.setDefaultLookAndFeelDecorated(false);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Compras_Calzado().setVisible(true);
            }
        });
    }
