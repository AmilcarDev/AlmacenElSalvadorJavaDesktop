 ...
 * @author Baltazar
 */
public class Compras_Perfume extends javax.swing.JFrame {

    int cont=0;
    public Compras_Perfume() {
        initComponents();
...
//        JFrame.setDefaultLookAndFeelDecorated(false);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Compras_Perfume().setVisible(true);
            }
        });
    }
