 ...
 * @author Baltazar
 */
public class Compras_Perfume1 extends javax.swing.JFrame {
    ...
    String sql_tabla = "Select Id_Producto,Nombre_Producto,Contenido,Marca,Aroma,Color from producto";
    int cont = 0;
    ...
    String Contenido_Producto;
    String Marca_Producto;
    String Aroma_Producto;
    ...
    public Compras_Perfume1(ModeloSession mss) {
        initComponents();
        this.mss=mss;
        ...
        Ajuste_Columna_Tabla(JT_Compra, 2, 70, 70, 70);
    ...
    public void Llenar(String SQL, String tabla) {
        ...
        Ajuste_Columna_Tabla(JT_Tabla, 2, 70, 70, 70);
        CentrarColumna(2);
        CentrarColumna(3);
        Datos.abrirConexion();
        try {
    ...
    public void llenarTabla_compra() {
        ...
        dt2.addRow(new Object[]{Id_Producto, Nombre_Producto, Contenido_Producto, Marca_Producto, Aroma_Producto, Color_Producto, TFRI_Cantidad.getText(), String.valueOf(df.format(Precio))});
        total = 0;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Administración de Compra Perfume");
        jLabel2.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        panelRectTranslucido1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, -1, -1));
        ...
        JT_Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Contenido", "Marca", "Aroma", "Color"
            }
        ));
        ...
        JT_Compra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Contenido", "Marca", "Aroma", "Color", "Cantidad", "Precio"
            }
        ));
    ...
    private void JT_TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JT_TablaMouseClicked
        ...
        Contenido_Producto = JT_Tabla.getValueAt(filaSeleccionada, 2).toString();
        Marca_Producto = JT_Tabla.getValueAt(filaSeleccionada, 3).toString();
        Aroma_Producto = JT_Tabla.getValueAt(filaSeleccionada, 4).toString();
...
//        if (msm.ms_pregunta("Confirme: ¿Desea realizar esta compra?") == 0) {
        if (0 != validar2()) {
            ...
            cb.insertarAccion(mss.getNombre(),"Registró Compra Perfume");
            ...
            for (int i = 0; i < JT_Compra.getRowCount(); i++) {
                ...
                cb.insertarAccion(mss.getNombre(),"Modifico inventario");
            }
            Datos.cerrarConexion();
            limpiar();
            limpiar_Tabla();
...
//            public void run() {
//                new Compras_Perfume1().setVisible(true);
//            }
//        });
//    }
