 ...
 * @author Baltazar
 */
public class Compras_Producto extends javax.swing.JFrame {
    ...
    String sql_tabla = "Select Id_Producto,Nombre_Producto,Talla,Estilo,Color,Marca from producto";
    int cont = 0;
    ...
    public Compras_Producto(ModeloSession mss) {
        initComponents();
    ...
    public void llenarTabla_compra() {
        ...
        dt2.addRow(new Object[]{Id_Producto, Nombre_Producto, Talla_Producto, Estilo_Producto, Color_Producto, Marca_Producto, TFRI_Cantidad.getText(), String.valueOf(df.format(Precio))});
        total = 0;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Administración de Compra Ropa");
        ...
        JT_Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Talla", "Estilo", "Color", "Marca"
            }
        ));
        ...
        JT_Compra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Talla", "Estilo", "Color", "Marca", "Cantidad", "Precio"
            }
        ));
    ...
    private void JT_TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JT_TablaMouseClicked
        ...
        Estilo_Producto = JT_Tabla.getValueAt(filaSeleccionada, 3).toString();
        Color_Producto = JT_Tabla.getValueAt(filaSeleccionada, 4).toString();
        Marca_Producto = JT_Tabla.getValueAt(filaSeleccionada, 5).toString();
...
//        if (msm.ms_pregunta("Confirme: ¿Desea realizar esta compra?") == 0) {
        if (0 != validar2()) {
            ...
            cb.insertarAccion(mss.getNombre(),"Registro compra de ropa");
...
//            public void run() {
//                new Compras_Producto().setVisible(true);
//            }
//        });
//    }
