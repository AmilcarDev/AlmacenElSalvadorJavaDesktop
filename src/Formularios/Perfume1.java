 ...
 * @author Baltazar
 */
public class Perfume1 extends javax.swing.JFrame {
    ...
    Boolean b_aroma = false;
    Boolean b_contenido = false;
    ...
    String Nombre_Marca;
    String Nombre_Color;
    String sql_tabla = "Select Id_Producto,Nombre_Producto,Aroma,Contenido,Color,Marca,Id_Proveedor,Clasificacion,Categoria,Estado from producto";
    ...
    public Perfume1(ModeloSession mss) {
        initComponents();
        this.mss=mss;
        ...
        JC_Aroma.setBackground(Color.WHITE);
        JC_Contenido.setBackground(Color.WHITE);
    ...
    public void cargarFoto() {
        ...
        j.setCurrentDirectory(new File("C:\\Users\\Baltazar\\Documents\\Productos Almacen\\Perfumes"));
...
//        Ajuste_Columna_Tabla(JT_Tabla, 9, 0, 0, 0);
        ...
        try {
            ...
            while (Datos.rs.next()) {
                ...
                v.add(Datos.rs.getString("Aroma"));
                v.add(Datos.rs.getString("contenido"));
    ...
    public void Limpiar() {
        ...
        JC_Aroma.removeAllItems();
        JC_Contenido.removeAllItems();
...
//        JCB_Categoria.setSelectedIcon(new ImageIcon(getClass().getResource("/" + paquete + "/Agregar.png")));
    ...
    private void initComponents() {
        ...
        JC_Contenido = new org.edisoncor.gui.comboBox.ComboBoxRound();
        ...
        JC_Aroma = new org.edisoncor.gui.comboBox.ComboBoxRound();
        JCB_Contenido = new javax.swing.JCheckBox();
        JCB_Marca = new javax.swing.JCheckBox();
        JCB_Color = new javax.swing.JCheckBox();
        JCB_Aroma = new javax.swing.JCheckBox();
        TFRI_Aroma = new org.edisoncor.gui.textField.TextFieldRoundImage();
        TFRI_Contenido = new org.edisoncor.gui.textField.TextFieldRoundImage();
        ...
        jLabel2.setText("Administración de Perfume");
        ...
        jPanel1.add(TFRI_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 195, -1));

        jLabel22.setText("Proveedor");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, -1, -1));

        jLabel23.setText("Nombre");
        jPanel1.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, -1, -1));

        jLabel28.setText("Categoría");
        jPanel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, -1, -1));

        jLabel29.setText("Sección");
        jPanel1.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 80, 80, 10));
        ...
        jPanel1.add(JC_Clasificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 80, 130, -1));
        ...
        jPanel1.add(JC_Proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 130, -1));

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Detalles"));
        jPanel5.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        JC_Contenido.setAnchoDeBorde(2.0F);
        JC_Contenido.setColorDeBorde(new java.awt.Color(173, 173, 173));
        JC_Contenido.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        JC_Contenido.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JC_ContenidoActionPerformed(evt);
            }
        });
        jPanel5.add(JC_Contenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(405, 48, 140, -1));
        ...
        jPanel5.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 101, -1, -1));

        jLabel51.setText("Marca");
        jPanel5.add(jLabel51, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 76, -1, -1));

        jLabel50.setText("Aroma");
        jPanel5.add(jLabel50, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 28, -1, -1));

        jLabel54.setText("Contenido");
        jPanel5.add(jLabel54, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 50, -1, -1));
        ...
        JC_Aroma.setAnchoDeBorde(2.0F);
        JC_Aroma.setColorDeBorde(new java.awt.Color(173, 173, 173));
        JC_Aroma.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jPanel5.add(JC_Aroma, new org.netbeans.lib.awtextra.AbsoluteConstraints(405, 22, 140, -1));

        JCB_Contenido.setBackground(new java.awt.Color(255, 255, 255));
        JCB_Contenido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Agregar.png"))); // NOI18N
        JCB_Contenido.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JCB_ContenidoActionPerformed(evt);
            }
        });
        jPanel5.add(JCB_Contenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 48, -1, -1));
        ...
        JCB_Aroma.setBackground(new java.awt.Color(255, 255, 255));
        JCB_Aroma.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Agregar.png"))); // NOI18N
        JCB_Aroma.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JCB_AromaActionPerformed(evt);
            }
        });
        jPanel5.add(JCB_Aroma, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 22, -1, -1));

        TFRI_Aroma.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        TFRI_Aroma.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TFRI_AromaActionPerformed(evt);
            }
        });
        TFRI_Aroma.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TFRI_AromaKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TFRI_AromaKeyTyped(evt);
            }
        });
        jPanel5.add(TFRI_Aroma, new org.netbeans.lib.awtextra.AbsoluteConstraints(405, 22, 140, -1));

        TFRI_Contenido.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        TFRI_Contenido.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TFRI_ContenidoActionPerformed(evt);
            }
        });
        TFRI_Contenido.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TFRI_ContenidoKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TFRI_ContenidoKeyTyped(evt);
            }
        });
        jPanel5.add(TFRI_Contenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(405, 48, 140, -1));
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 630, 140));

        jLabel25.setText("Precio unitario");
        jPanel1.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 60, -1, -1));

        jLabel27.setText("Cantidad");
        jPanel1.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 30, -1, -1));
        ...
        jPanel1.add(JC_Categoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 130, -1));
        ...
        jPanel1.add(TFRI_Categoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 130, -1));
        ...
        jPanel1.add(JB_Salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 310, -1, -1));
        ...
        jPanel1.add(JB_Cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 310, -1, -1));
        ...
        jPanel1.add(JB_Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 310, -1, -1));
        ...
        jPanel1.add(JB_Nuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 310, -1, -1));
        ...
        jPanel1.add(JCB_Clasificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 75, -1, -1));
        ...
        jPanel1.add(JCB_Categoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 45, -1, -1));
        ...
        jPanel1.add(JCB_Proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 105, -1, -1));
        ...
        jPanel1.add(TFRI_Cantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 20, 115, -1));
        ...
        jPanel1.add(TFRI_Clasificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 80, 130, -1));
        ...
        jPanel1.add(TFRI_Proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 130, -1));
        ...
        jPanel1.add(TFRI_Precio_Unitario, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 50, 115, -1));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 80, -1, 60));
        ...
        jPanel1.add(JB_Modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 310, -1, -1));
        ...
        jPanel1.add(JB_Cancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 310, -1, -1));

        lblfoto.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(lblfoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 200, 250));
        ...
        jPanel1.add(btnsubir, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, -1, -1));
        ...
        JT_Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Aroma", "Contenido", "Color", "Marca", "Proveedor", "Clasificacion", "Categoria", "Estado"
            }
        ) {
        ...
        jPanel6.add(JTP_Pestaña, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 940, 390));
    ...
    private void TFRI_AromaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TFRI_AromaActionPerformed
        Buscar_Existencia(TFRI_Aroma, "aroma", "Nombre_Aroma");
    }//GEN-LAST:event_TFRI_AromaActionPerformed
    ...
    private void JB_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_GuardarActionPerformed
        Buscar_Existencia2(TFRI_Aroma, "aroma", "Nombre_Aroma");
        Buscar_Existencia2(TFRI_Contenido, "contenido", "Nombre_Contenido");
        ...
        if (0 != validar()) {
            ...
            if (Integer.parseInt(TFRI_Existencia_Minima.getText()) < Integer.parseInt(TFRI_Cantidad.getText())) {
                ...
                metodos.setAroma(Nombre_Aroma);
                metodos.setContenido(Nombre_Contenido);
                ...
                Datos.Insertar_Datos_Perfume(metodos);
                ...
                cb.insertarAccion(mss.getNombre(),"Registró Perfume");
    ...
    public void ValoresBanderas() {
        ...
        b_aroma = false;
        JC_Aroma.setVisible(true);
        JCB_Aroma.setIcon(new ImageIcon(getClass().getResource("/" + paquete + "/Agregar.png")));

        b_contenido = false;
        JC_Contenido.setVisible(true);
        JCB_Contenido.setIcon(new ImageIcon(getClass().getResource("/" + paquete + "/Agregar.png")));
    ...
    public void CargarCombo() {
        ...
        cargarCombo(JC_Aroma, "select * from aroma where Id_Departamento=" + Numero_Departamento + "", "aroma");
        cargarCombo(JC_Contenido, "select * from contenido where Id_Departamento=" + Numero_Departamento + "", "contenido");
    ...
    private void TFRI_ContenidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TFRI_ContenidoActionPerformed
        Buscar_Existencia(TFRI_Contenido, "contenido", "Nombre_Contenido");
    }//GEN-LAST:event_TFRI_ContenidoActionPerformed

    private void JCB_AromaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JCB_AromaActionPerformed
        if (JCB_Aroma.isSelected() == true) {
            b_aroma = true;
            TFRI_Aroma.requestFocus();
            JC_Aroma.setVisible(false);
            JCB_Aroma.setIcon(new ImageIcon(getClass().getResource("/" + paquete + "/AgregarRojo.png")));
        } else {
            b_aroma = false;
            JC_Aroma.setVisible(true);
            JCB_Aroma.setIcon(new ImageIcon(getClass().getResource("/" + paquete + "/Agregar.png")));
    ...
    }//GEN-LAST:event_JCB_AromaActionPerformed
    ...
    private void JCB_ContenidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JCB_ContenidoActionPerformed
        if (JCB_Contenido.isSelected() == true) {
            b_contenido = true;
            JC_Contenido.setVisible(false);
            TFRI_Contenido.requestFocus();
            JCB_Contenido.setIcon(new ImageIcon(getClass().getResource("/" + paquete + "/AgregarRojo.png")));
        } else {
            b_contenido = false;
            JC_Contenido.setVisible(true);
            JCB_Contenido.setIcon(new ImageIcon(getClass().getResource("/" + paquete + "/Agregar.png")));
    ...
    }//GEN-LAST:event_JCB_ContenidoActionPerformed
    ...
    private void JC_ContenidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JC_ContenidoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JC_ContenidoActionPerformed
...
//        }
    ...
    private void JT_TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JT_TablaMouseClicked
        ...
        cargarCombo(JC_Aroma, "select * from aroma where Id_Departamento=" + Numero_Departamento + "", "Talla");
        cargarCombo(JC_Contenido, "select * from contenido where Id_Departamento=" + Numero_Departamento + "", "Estilo");
        cargarCombo(JC_Color, "select * from color where Id_Departamento=" + Numero_Departamento + "", "Color");
        ...
        JC_Aroma.setSelectedItem(JT_Tabla.getValueAt(filaSeleccionada, 2).toString());
        JC_Contenido.setSelectedItem(JT_Tabla.getValueAt(filaSeleccionada, 3).toString());
    ...
    private void JB_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_ModificarActionPerformed
        if (0 != validar()) {
            ...
            if (Integer.parseInt(TFRI_Existencia_Minima.getText()) < Integer.parseInt(TFRI_Cantidad.getText())) {
                ...
                ////////////////////////////////////////////////////////////////////////////////////
                if (apretafoto == 1) {
                    Datos.ModificarDatosConFoto_Perfume(metodos);
                    ...
                    cb.insertarAccion(mss.getNombre(),"Modificó Perfume");
                } else {
                    Datos.ModificarDatosSinFoto_Perfume(metodos);
                    Datos.Modificar2("inventario", "Cantidad=" + Integer.parseInt(TFRI_Cantidad.getText()) + ",Precio_Venta=" + Float.parseFloat(TFRI_Precio_Venta.getText()) + "", "Producto_Id_Producto=" + id_Modificar_Producto + "");
                    cb.insertarAccion(mss.getNombre(),"Modificó Perfume");
                }
                this.Datos.cerrarConexion();
...
//        }
    ...
    private void TFRI_AromaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFRI_AromaKeyTyped
        char c = evt.getKeyChar();
        if (Character.isLowerCase(c)) {
            String cad = ("" + c).toUpperCase();
            c = cad.charAt(0);
        ...
        int limite = 18;
        if (TFRI_Aroma.getText().length() == limite) {
            evt.consume();
        }
        char ca = evt.getKeyChar();
        if ((ca < 'A' || ca > 'Z') && (ca != ' ')&& (ca < '0' || ca > '9') && (ca != '/') && (ca != '-')) {
    ...
    }//GEN-LAST:event_TFRI_AromaKeyTyped

    private void TFRI_ContenidoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFRI_ContenidoKeyTyped
        ...
        int limite = 10;
        if (TFRI_Contenido.getText().length() == limite) {
            evt.consume();
        }
        char ca = evt.getKeyChar();
        if ((ca < 'A' || ca > 'Z') && (ca != ' ')&& (ca < '0' || ca > '9') && (ca != '/') && (ca != '-')) {
    ...
    }//GEN-LAST:event_TFRI_ContenidoKeyTyped
    ...
    private void TFRI_AromaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFRI_AromaKeyReleased
        
    }//GEN-LAST:event_TFRI_AromaKeyReleased

    private void TFRI_ContenidoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFRI_ContenidoKeyReleased
        
    }//GEN-LAST:event_TFRI_ContenidoKeyReleased
    ...
    public void DesHabilitar() {
        ...
        JC_Aroma.setEditable(false);
        JC_Contenido.setEnabled(false);
        JC_Color.setEnabled(false);
        JC_Marca.setEditable(false);
        JC_Aroma.setEnabled(false);
        ...
        JCB_Aroma.setEnabled(false);
        JCB_Contenido.setEnabled(false);
        ...
        TFRI_Otro.setEnabled(false);
        TFRI_Aroma.setEnabled(false);
        TFRI_Contenido.setEnabled(false);
    ...
    public void Habilitar() {
        ...
        JC_Aroma.setEnabled(true);
        JC_Contenido.setEnabled(true);
        ...
        JCB_Aroma.setEnabled(true);
        JCB_Contenido.setEnabled(true);
        ...
        TFRI_Otro.setEnabled(false);
        TFRI_Aroma.setEnabled(true);
        TFRI_Contenido.setEnabled(true);
    ...
    public void Busqueda_Insercion() {
        ...
        //////////////////////////////////////////////////////////////////
        //           INSERCION O BUSQUEDA DE ID_aroma                   //
        //////////////////////////////////////////////////////////////////
        if (b_aroma == true) {
            ID_Aroma = BuscarID("select * from aroma", "aroma");
            ID_Aroma++;
            this.Datos.Insertar2("aroma", "Id_Aroma,Nombre_Aroma,Id_Departamento", "" + ID_Aroma + ",'" + TFRI_Aroma.getText() + "'," + Numero_Departamento + "");
            Nombre_Aroma = TFRI_Aroma.getText();

        } else {//Buscqueda de ID_Talla

            ID_Aroma = this.BuscarID("select * from aroma where Id_Departamento=" + Numero_Departamento + " AND Nombre_Aroma='" + JC_Aroma.getSelectedItem().toString() + "'", "Talla");
            System.out.print("ID_Talla= " + ID_Aroma + "\n");
            Nombre_Aroma = JC_Aroma.getSelectedItem().toString();
        ...
        //////////////////////////////////////////////////////////////////
        if (b_contenido == true) {
            ID_Contenido = BuscarID("select * from contenido", "contenido");
            ID_Contenido++;
            this.Datos.Insertar2("contenido", "Id_Contenido,Nombre_Contenido,Id_Departamento", "" + ID_Contenido + ",'" + TFRI_Contenido.getText() + "'," + Numero_Departamento + "");
            Nombre_Contenido = TFRI_Contenido.getText();

        } else {//Buscqueda de ID_Estilo
            ID_Contenido = this.BuscarID("select * from estilo where Id_Departamento=" + Numero_Departamento + " AND Nombre_Estilo='" + JC_Contenido.getSelectedItem().toString() + "'", "Estilo");
            System.out.print("ID_Estilo= " + ID_Contenido + "\n");
            Nombre_Contenido = JC_Contenido.getSelectedItem().toString();
    ...
    public int validar() {
        ...
        if (b_aroma == true) {
            if (TFRI_Aroma.getText().trim().equals("")) {
                op = 9;
                mensaje = mensaje + "Aroma                    Agregue o Seleccione una opcion\n";
            }
        } else {
            if (JC_Aroma.getItemCount() == 0) {
                op = 9;
                mensaje = mensaje + "Aroma                    Agregue o Seleccione una opcion\n";
            }
        ...
        if (b_contenido == true) {
            if (TFRI_Contenido.getText().trim().equals("")) {
                op = 10;
                mensaje = mensaje + "Contenido              Agregue o Seleccione una opcion\n";
            }
        } else {
            if (JC_Contenido.getItemCount() == 0) {
                op = 10;
                mensaje = mensaje + "Contenido              Agregue o Seleccione una opcion\n";
            }
...
//    }
    ...
    private javax.swing.JCheckBox JCB_Aroma;
    ...
    private javax.swing.JCheckBox JCB_Contenido;
    ...
    private org.edisoncor.gui.comboBox.ComboBoxRound JC_Aroma;
    ...
    private org.edisoncor.gui.comboBox.ComboBoxRound JC_Contenido;
    ...
    private org.edisoncor.gui.textField.TextFieldRoundImage TFRI_Aroma;
    ...
    private org.edisoncor.gui.textField.TextFieldRoundImage TFRI_Contenido;
